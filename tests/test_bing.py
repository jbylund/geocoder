...
def test_bing_details():
    ...
    details = {"addressLine": "6912 Route 8", "adminDistrict": "Northumberland", "countryRegion": "CA", "locality": "Ludlow"}
...
def test_bing_batch_forward():
    ...
    with requests_mock.Mocker() as mocker, open(submission_file, "rb") as submission_result, open(
        confirmation_file, "rb"
    ) as confirmation_result, open(data_file, "rb") as batch_result:
        ...
        assert g.ok
        assert len(g) == 2
        expected_results = [[39.7400093078613, -104.99201965332], [40.015739440918, -105.279243469238]]
