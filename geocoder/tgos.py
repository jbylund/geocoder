    ...
    def street(self):
        if bool(self.road and self.section):
            return "{road}{section}{segment}".format(
                road=self.road, section=self.section, segment={"zh-tw": "段", "en": "Segement"}[self.language]
            )
        return self.road
    ...
    def section(self):
        ...
        if section:
            if self.language == "zh-tw":
                return {0: "零", 1: "一", 2: "二", 3: "三", 4: "四", 5: "五", 6: "六", 7: "七", 8: "八", 9: "九"}[int(section)]
            return int(section)
