...
class TamuQuery(MultipleResultsQuery):
    ...
    _URL = "https://geoservices.tamu.edu/Services/Geocode/WebService" "/GeocoderWebServiceHttpNonParsed_V04_01.aspx"
    ...
    def _catch_errors(self, json_response):
        ...
        if status_code == "401" or status_code == "470":
            self.error = "Tamu returned status_code {0}.  Is API key {1} valid?".format(status_code, self.key)
...
if __name__ == "__main__":
    ...
    g = TamuQuery("595 Market Street", city="San Francisco", state="CA", zipcode="94105")
